...
if (isset($_GET['del'])) {
	...
	if (isset($_GET['view'])) {
		...
		echo "<a href='".FUSION_SELF.$aidlink."&amp;del=".stripinput($_GET['view'])."'>".$locale['442']."</a><br /><br />\n<a href='".FUSION_SELF.$aidlink."'>".$locale['402']."</a><br /><br />\n</div>\n";
		closetable();
	} else {
		...
		if ($image_list) {
			for ($i=0;$i < $image_count;$i++) {
				...
				echo "<td align='right' width='1%' class='$row_color' style='white-space:nowrap'><a href='".FUSION_SELF.$aidlink."&amp;view=".$image_list[$i]."'>".$locale['461']."</a> -\n";
				echo "<a href='".FUSION_SELF.$aidlink."&amp;del=".$image_list[$i]."' onclick=\"return confirm('".$locale['470']."');\">".$locale['462']."</a></td>\n";
				echo "</tr>\n";
			}
		} else {
