...
// Sprawdzanie czy zosta³ uzupe³niony profil
if ($userdata['surname'] == "" || $userdata['name'] == "") { 
  echo "<div align='center' class='admin-message'>".$locale['450']."</div>";
}
$offset_list = "";
for ($i = -13; $i < 17; $i++) {
...
echo "<td class='tbl'>".$locale['u014'].":<span style='color:#ff0000'>*</span></td>\n";
echo "<td class='tbl'><input type='text' name='name' value='".$user_data['name']."' maxlength='100' class='textbox' style='width:200px;' /></td>\n";
echo "</tr>\n<tr>\n";
echo "<td class='tbl'>".$locale['u015'].":<span style='color:#ff0000'>*</span></td>\n";
