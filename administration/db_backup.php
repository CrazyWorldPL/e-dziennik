...
if(isset($_POST['btn_create_backup'])){
	if (md5(md5($_POST['user_admin_password'])) != $userdata['user_admin_password']) {
...
if (isset($_POST['btn_do_restore'])) {
	...
	echo "<td class='tbl'><input type='text' name='backup_filename' value='backup_".date('Y-m-d-Hi')."' class='textbox' style='width:200px;' /></td>\n";
	echo "</tr>\n<tr>\n";
