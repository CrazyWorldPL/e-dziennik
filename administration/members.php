...
if ($_GET['step'] == "view" && isnum($_GET['user_id'])) {
	...
	if (!$user_data || $user_data['user_level'] >= 104) { redirect(FUSION_SELF.$aidlink); }
	...
	if ($rows) {
		...
		while ($data = dbarray($result)) {
			...
			if ($data['user_level'] < 104) echo "<a href='".FUSION_SELF.$aidlink."&amp;step=edit&amp;user_id=".$data['user_id']."'>".$locale['406']."</a>\n";
			if ($data['user_status'] == "2") {
				...
				if ($data['user_level'] < 104) echo "- <a href='".FUSION_SELF.$aidlink."&amp;step=ban&amp;act=on&amp;".$list_link."&amp;status=".$_GET['status']."&amp;rowstart=".$_GET['rowstart']."&amp;user_id=".$data['user_id']."'>".$locale['409']."</a>\n";
			}
			if ($data['user_level'] < 104) echo "- <a href='".FUSION_SELF.$aidlink."&amp;step=delete&amp;".$list_link."&amp;status=".$_GET['status']."&amp;rowstart=".$_GET['rowstart']."&amp;user_id=".$data['user_id']."' onclick='return DeleteMember();'>".$locale['410']."</a>";
			echo "</td>\n</tr>\n"; $i++;
		}
		echo "</table>\n";
	} else {
