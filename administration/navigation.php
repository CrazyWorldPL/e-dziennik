...
$page1 = false; $page2 = false; $page3 = false; $page4 = false; $page5 = false; $index_link = false;
for ($i = 1; $i < 6; $i++) {
	$admin_nav_opts = "";
	...
	if ($rows != 0) {
		while ($data = dbarray($result)) {
			if (iADMIN) {
				...
				elseif ($i == 5) { $page5 = true; }
				if (($page1 || $page2 || $page3 || $page4 || $page5) && !$index_link) {
...
if ($page1 || $page2 || $page3 || $page4 || $page5) { echo "<hr class='side-hr' />\n"; }
