...
while($data = dbarray($result)){
	$ac_images["ac_".$data['admin_title']] = file_exists(ADMIN."images/".$data['admin_image']) ? ADMIN."images/".$data['admin_image'] : ADMIN."images/infusion_panel.png";
}
...
$fusion_images = array(
	...
	//V
	//W
	"web" => THEME."images/web.gif"
	//X
	//Y
	//Z
);

$fusion_images = array_merge($ac_images, $fusion_images, $smiley_images);
