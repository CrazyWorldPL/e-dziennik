...
if (!isset($_GET['group_id']) || !isnum($_GET['group_id'])) {
	...
	if (iADMIN && $user_data['user_id'] != $userdata['user_id']) {
	...
	echo "</tr>\n<tr>\n";
	echo "<td width='1%' class='tbl1' style='white-space:nowrap'>".$locale['u014']."</td>\n";
	echo "<td align='right' class='tbl1'>".$user_data['name']."</td>\n";
	echo "</tr>\n<tr>\n";
	echo "<td width='1%' class='tbl1' style='white-space:nowrap'>".$locale['u015']."</td>\n";
	echo "<td align='right' class='tbl1'>".$user_data['surname']."</td>\n";
	echo "</tr>\n<tr>\n";
